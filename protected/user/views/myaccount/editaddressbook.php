                        ...
                        <div class="row">
                            <div class="strip-padding">
                                ...
                                <div class="copyz">
                                    ...
                                    <div class="col-sm-8 col-xs-8 zeros">
                                        <?php echo CHtml::activeDropDownList($model, 'country', CHtml::listData(Countries::model()->findAll(), 'id', 'country_name'), array('empty' => '--Select Country--', 'class' => 'form-new-profile')); ?>
