                        ...
                        if (!empty($cart_contents)) {
                                ...
                                foreach ($cart_contents as $cart_content) {
                                        ...
                                        if ((Yii::app()->session['location']) && (Yii::app()->session['location'] == 'MARINA')) {
                                                ...
                                                $pricen = $prod_details->price_in_marina;
                                        } else {
                                                $pricen = $prod_details->price_in_barsha;
                                        }
                                        $total = $cart_content->quantity * $pricen;
                                        ...
                                        $subtotoal1 = number_format($subtotoal, 2);
                                }
                                $this->renderPartial('_cartfooter', array('subtotoal' => $subtotoal1));
                                echo ' </div>';
                        } else {
        ...
        public function actionGetcarttotal() {
                ...
                if (isset(Yii::app()->session['user']['id'])) {
                        ...
                        if (!empty($cart_items)) {
                                foreach ($cart_items as $cart_item) {
                                        ...
                                        if ((Yii::app()->session['location']) && (Yii::app()->session['location'] == 'MARINA')) {
                                                ...
                                                $pricen = $product->price_in_marina;
                                        } else {
                                                $pricen = $product->price_in_barsha;
                                        }
                                        $ptotal = $pricen * $cart_item->quantity;
                                        //$subtotoal = $subtotoal + $total;
                                        $carttotal += $ptotal;
                                }
                        ...
                        if (isset(Yii::app()->session['temp_user'])) {
                                ...
                                if (!empty($cart_items)) {
                                        foreach ($cart_items as $cart_item) {
                                                $products = Products::model()->findByPk($cart_item->product_id);
                                                if ((Yii::app()->session['location']) && (Yii::app()->session['location'] == 'MARINA')) {

                                                        $pricen = $products->price_in_marina;
                                                } else {
                                                        $pricen = $products->price_in_barsha;
                                                }
                                                $ptotal = $pricen * $cart_item->quantity;
                                                $carttotal += $ptotal;
                                        }
                ...
                if (!empty($cart)) {
                        ...
                        if (!empty($cart_contents)) {
                                ...
                                foreach ($cart_contents as $cart_content) {
                                        ...
                                        $total = $prod_details->quantity * $pricen;
