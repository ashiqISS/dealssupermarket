...
class UserAddress extends CActiveRecord {
        ...
        public function rules() {
                ...
                return array(
                    ...
                    array('userid, first_name, last_name,company, contact_number, address_1, city, postcode, country, state', 'required'),
                    array('userid, country, CB, UB, contact_number, postcode', 'numerical', 'integerOnly' => true),
                    array('first_name, last_name, city, state', 'match', 'pattern' => '/^[a-zA-Z ]+$/'),
