...
//                        }
                        ...
                        $model->special_product_image = $special_image->extensionName;
...
//                        $model->CB = Yii::app()->session['admin']['id'];
                        ...
                        if ($model->validate()) {
                                ...
                                if ($model->save()) {
                                        ...
                                        if ($special_image != "") {
                                                ...
                                                Yii::app()->Upload->uploadImage($special_image, $id, true, $dimensions);
                                        }
        ...
        public function actionUpdate($id) {
                ...
                $image3 = $model->special_product_image;
                ...
                if (isset($_POST['Products'])) {
                        ...
                        if ($special_image != "") {
                                ...
                                $model->special_product_image = $image3;
                        }
