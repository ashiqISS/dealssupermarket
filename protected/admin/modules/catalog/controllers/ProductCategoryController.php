...
// $this->performAjaxValidation($model);
                ...
                if(isset($_POST['ProductCategory'])) {
                        ...
                        if($model->save()) {
                                if($image != "") {
                                        $id = $model->id;
                                        if(!is_dir(Yii::app()->basePath . '/../uploads/products/'))
                                                mkdir(Yii::app()->basePath . '/../uploads/products/');
                                        chmod(Yii::app()->basePath . '/../uploads/products/', 0777);
                                        if(!is_dir(Yii::app()->basePath . '/../uploads/products/category/'))
                                                mkdir(Yii::app()->basePath . '/../uploads/products/category/');
                                        chmod(Yii::app()->basePath . '/../uploads/products/category/', 0777);
