...
class UserDetailsController extends Controller {
        ...
        public function actionUpdate($id) {
                ...
                if(isset($_REQUEST['address']) && $_REQUEST['address'] != '') {
                        $address = UserAddress::model()->findByAttributes(array('userid' => $id, 'id' => $_REQUEST['address']));
                } else {
                ...
                if(isset($_POST['UserAddress'])) {
                        ...
                        $address->userid = $model->id;
                        if($address->save()) {

                                $this->redirect(array('update', 'id' => $model->id));
                        }
                }
                $address1 = new UserAddress('search');
                $address1->scenario = 'search';
                $address1->unsetAttributes();  // clear any default values
                if(isset($_GET['UserAddress'])) {

                        $address1->attributes = $_GET['UserAddress'];
                }


                $this->render('update', array(
                    'model' => $model, 'address' => $address, 'address1' => $address1
                ));
        }
