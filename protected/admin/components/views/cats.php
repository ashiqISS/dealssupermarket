...
<div class="col-sm-12 <?php echo $this->type; ?>_reciverr" id="<?php echo $this->type; ?>_close">
    ...
    if($this->field_val != '') {
            ...
            foreach($arrs as $val) {
                    ...
                    if($val != '')
                            echo '<div class="' . $this->type . '_tagedd">' . $cat . '<i class="glyphicon glyphicon-remove ' . $this->type . '_closee" id="' . $val . '"></i></div>';
            }
    }
    ?>
</div>
            ...
            $('#<?php echo $this->type; ?>_new_tag').on('click', '.<?php echo $this->type; ?>_need_add', function () {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        $('.<?php echo $this->type; ?>_reciverr').append('<div class="<?php echo $this->type; ?>_tagedd">' + val + '<i class="glyphicon glyphicon-remove <?php echo $this->type; ?>_closee"></i></div>')
            ...
            $('#<?php echo $this->type; ?>_tag_select').on('keyup', function (event) {
                 ...
                 */
                    ...
                    if ($(this).val() != '' && $(".<?php echo $this->type; ?>_tag-sub").hasClass("<?php echo $this->type; ?>_activee")) {
                        ...
                        $('.<?php echo $this->type; ?>_reciverr').append('<div class="<?php echo $this->type; ?>_tagedd">' + $('.<?php echo $this->type; ?>_activee').html() + '<i class="glyphicon glyphicon-remove <?php echo $this->type; ?>_closee"></i></div>')
...
<?php echo $this->type; ?>SelectTag($(this).val());
            ...
            $("#<?php echo $this->type; ?>_new_tag").on('click', '.<?php echo $this->type; ?>_tag-sub', function () {
                $('.<?php echo $this->type; ?>_reciverr').append('<div class="<?php echo $this->type; ?>_tagedd">' + $(this).html() + '<i class="glyphicon glyphicon-remove <?php echo $this->type; ?>_closee"></i></div>')
            ...
            $('#<?php echo $this->type; ?>_close').on('click', '.<?php echo $this->type; ?>_closee', function () {
                ...
                var parent_res = parent.replace('<i class="glyphicon glyphicon-remove <?php echo $this->type; ?>_closee"></i>', "");
